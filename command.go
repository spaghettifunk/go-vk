// Code generated by go-vk from vk.xml at 2024-10-03 15:43:53.554047 +0200 CEST m=+1.483054418. DO NOT EDIT.
...
func GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(device Device, renderpass RenderPass) (r error) {
	// Parameter is binding-allocated array populated by Vulkan; length is possibly embedded in a struct (1) - maxWorkgroupSize

	r = Result(execTrampoline(vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI, uintptr(device), uintptr(renderpass)))
...
var vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI = &vkCommand{"vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI", 2, true, nil}
